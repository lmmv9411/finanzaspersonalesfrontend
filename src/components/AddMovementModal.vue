<template>
    <div>
        <button
                class="bg-indigo-500 rounded-full hover:bg-indigo-700 text-white p-4 fixed bottom-6 right-6 shadow-lg transition duration-300 ease-in-out cursor-pointer"
