...
<script setup>
import { AdjustmentsVerticalIcon, ArrowRightStartOnRectangleIcon, ChartBarIcon, HomeIcon, PlusIcon, Squares2X2Icon } from '@heroicons/vue/24/solid';
...
const menu = [
    ...
    { name: 'Gestión', to: '/catalogs', icon: Squares2X2Icon },
